...
<section class="hero">
  <div class="hero-bg" aria-hidden="true">
    <video autoplay muted loop playsinline preload="metadata" poster="/assets/media/hero-poster.jpg">
      <source src="/assets/media/hero-loop.webm" type="video/webm"><source src="/assets/media/hero-loop.mp4" type="video/mp4">
    </video>
  </div>
  <div class="wrap">
    <div class="hero-copy">
    ...
    <div class="hero-visual rv rv-d2">
      <div class="hud">
        ...
        <video autoplay muted loop playsinline preload="auto" poster="/assets/media/hero-poster.jpg">
          <source src="/assets/media/hero-loop.webm" type="video/webm"><source src="/assets/media/hero-loop.mp4" type="video/mp4">
        </video>
        ...
        <span class="hud-tag b">[B0] cohort_01</span>
      </div>
    </div>
  </div>
</section>
